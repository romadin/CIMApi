...
//        ],
        ...
        'Model afspraken' => [
            ['name' => 'NUL-punt', 'order' => 1, 'fromTemplate' => true, 'folderName' => 'zeroPoint'],
            ['name' => 'Bestandnamen', 'order' => 2, 'fromTemplate' => true, 'folderName' => 'fileNames'],
            ['name' => 'Nauwkeurigheid en toleranties', 'order' => 3, 'fromTemplate' => true, 'folderName' => 'accuracyAndTolerances'],
            ['name' => 'IFC export instelling', 'order' => 4, 'fromTemplate' => true, 'folderName' => 'ifcExport'],
            ['name' => 'Object- en materiaalbeschrijving', 'order' => 5, 'fromTemplate' => true, 'folderName' => 'materialDescription'],
            ['name' => 'Shared parameters', 'order' => 6, 'fromTemplate' => true, 'folderName' => 'sharedParameters'],
            ['name' => 'Niet-gemodelleerde onderdelen', 'order' => 7, 'fromTemplate' => true, 'folderName' => 'nonModeledParts'],
            ['name' => 'Demarcatie ‘2D – 3D’ / Geometrie – data', 'order' => 8, 'fromTemplate' => true, 'folderName' => 'GeometricData'],
            ['name' => 'Detailniveau export IFC', 'order' => 9, 'fromTemplate' => true, 'folderName' => 'detailLevelExportIFC'],
        ],
        'Planning' => [
